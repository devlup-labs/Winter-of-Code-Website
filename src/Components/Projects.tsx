...
const Projects = () => {
  ...
  const accounts: project[] = [
    ...
    },
    {
      ...
      "description": "FTP Server, a cool project to make file sharing a breeze on your institute's intranet. Effortlessly sending files between devices connected to the same Wi-Fi, without the hassle of network logins. It's a smart, secure, and user-friendly system. Basically, it is a peer-to-peer file-sharing solution.",
    ...
    },
    {
      ...
      "description": "Improve the WOC website by replacing the existing code written in Vue with React. This will involve integrating the React code with the website's existing backend. The goal of this project is to improve the website's performance, scalability, and maintainability.",
      "mentor": "Piyush Jhamnani",
      "tech": "React JS"
    },
    {
      ...
      "description": "Secure Shell (SSH) is a way to establish a secure bi-directional persistent connection between a client machine and a remote machine (typically a server or a VM). A secure and user-friendly system that eliminates the need for traditional SSH keys to access remote virtual machines (VMs). This innovative solution enables users to authenticate themselves using their email and password, providing a seamless and accessible method for VM access.",
            ...
            <div className="mx-8">
                <div className="fontstylish" >
                    ...
                    <div className="mx-2 scroll-m-12 md4">
                        ...
                        <span className="rounded-full px-4 py-2 bg-gray-300">{x.tech}</span>
